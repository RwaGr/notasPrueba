...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        listarNotas: function listarNotas() {
            var me = this;
        ...
        eliminarNota: function eliminarNota(id) {
            var _this = this;
            ...
            swal({
                ...
                if (result.value) {
                    ...
                    axios.delete(url).then(function (response) {
                        me.listarNotas();
                        swal('Eliminado!', 'La nota ha sido eliminada con éxito.', 'success');
                    }).catch(function (error) {
                        console.log(error);
                    });
                } else if (
              ...
              _c(
                ...
                _vm._l(_vm.arrayNotas, function(notas) {
                  return _c("tr", { key: notas.id }, [
                    _c("td", [
                      _c(
                        "button",
                        {
                          ...
                          on: {
                            click: function($event) {
                              _vm.abrirModal("actualizar", notas)
                            }
                          }
                        },
                    ...
                    _vm._v(" "),
                    _c("td", {
                      domProps: { textContent: _vm._s(notas.title) }
                    }),
                    _vm._v(" "),
                    _c("td", {
                      domProps: { textContent: _vm._s(notas.content) }
                    })
                  ])
                })
              )
